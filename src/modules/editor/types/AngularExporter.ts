...
export class AngularExporter {
    ...
    constructor(projectName: string = 'my-angular-design') {
        this.zip = new JSZip();
     ...
     */
    async exportToAngular(shapes: ShapeAttributes[]) {
     ...
     */
    private generateTemplate(shapes: ShapeAttributes[]): string {
     ...
     */
    private generateStyles(shapes: ShapeAttributes[]): string {
  ...
  transform-origin: center;
     ...
     */
    private generateShapeStyle(shape: ShapeAttributes, id: string): string {
        let style = `#${id} {\n`;
